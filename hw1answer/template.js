$(function(){
	...
	var response = prompt('(a)nimal (c)olors or (p)eople, or (q)uit');
	...
	while(response != 'q')
	{
		...
		response = prompt('(a)nimal (c)olors or (p)eople, or (q)uit');
	}

	response = prompt('do yo want to remove (c)olor, (p)erson, (a)nimal or (q)uit?');
